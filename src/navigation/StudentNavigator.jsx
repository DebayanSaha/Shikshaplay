...
import StudentMeetingsScreen from "../screens/StudentMeetingsScreen";
...
const mapScreenToPath = (screen) => {
  switch (screen) {
    case "PdfViewer":
      return "/student/pdf-viewer";
    case "CircuitBuilder":
      return "/student/games/circuit";
    case "OhmCalculator":
      return "/student/games/ohm";
    case "CodeCompiler":
      return "/student/games/compiler";
    case "PH":
      return "/student/games/ph";
    case "Atoms":
      return "/student/games/atoms";
    case "NewtonsLaws":
    case "NewtonsLawsScreen":
      return "/student/games/newton";
    case "Conductivity":
      return "/student/games/conductivity";
    case "Sound":
      return "/student/games/sound";
    case "Neuron":
      return "/student/games/neuron";
    default:
      return screen?.startsWith("/") ? screen : `/student/${screen}`;
  }
};
...
const StudentNavigator = () => {
  return (
    <Routes>
      ...
      <Route path="meetings" element={<StudentMeetingsScreen />} />
      <Route path="notes" element={<StudentNotesScreen />} />
      <Route path="exams" element={<StudentExamsScreen />} />
