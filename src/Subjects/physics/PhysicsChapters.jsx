...
const AVAILABLE_SCREENS = [
  'G6PChapter1','G6PChapter2','G6PChapter3',
  'G7PChapter1','G7PChapter2','G8PChapter1','G8PChapter2',
  'G9PChapter1','G9PChapter2','G10PChapter1','G10PChapter2',
  'G11PChapter1','G11PChapter2','G12PChapter1','G12PChapter2'
];

const PhysicsChapters = ({ navigate }) => {
  ...
  const translatedChaptersData = translateChaptersData(physicsChaptersData, t);
  ...
  const handleChapterPress = (chapter) => {
    if (AVAILABLE_SCREENS.includes(chapter.screen)) {
      // Route to /student/chapter/:id or /teacher/chapter/:id depending on navigator
      navigate(`chapter/${chapter.screen}`);
    } else {
      alert(
    ...
    <div className="flex flex-col min-h-screen bg-[#0f172a]">
      ...
      <div className="flex justify-between items-center px-5 pt-4 pb-5 mt-2 bg-purple-500">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-white font-bold text-xl">{t('subjects.physics.title')}</h1>
