// src/pages/ComputerChapters.jsx
import React, { useState } from "react";
import { useTranslation } from 'react-i18next';
import { computerScienceChaptersData } from "../../ChaptersData/ComputerData";
import { translateChaptersData } from "../../utils/translateChaptersData";

// Define available screens here
const AVAILABLE_SCREENS = [
  'G6ITChapter1','G6ITChapter2','G6ITChapter3',
  'G7ITChapter1','G7ITChapter2','G7ITChapter3',
  'G8ITChapter1','G8ITChapter2',
  'G9ITChapter1','G9ITChapter2',
  'G10ITChapter1','G10ITChapter2',
  'G11ITChapter1','G11ITChapter2',
  'G12ITChapter1','G12ITChapter2'
];

const ComputerChapters = ({ navigate }) => {
  ...
  const translatedChaptersData = translateChaptersData(computerScienceChaptersData, t);
    ...
    <div className="flex flex-col min-h-screen bg-[#0f172a]">
      ...
      <div className="flex justify-between items-center px-5 pt-4 pb-5 mt-2 bg-purple-500">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-white font-bold text-xl">{t('subjects.computer.title')}</h1>
...
export default ComputerChapters;
